  ...
  return (
    <main className="min-h-screen text-slate-900 dark:text-slate-100 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 glass-panel p-10 sm:p-16 rounded-3xl border border-rose-500/20 text-center space-y-6 max-w-xl">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white">Oops! Coś poszło nie tak</h1>
        
        <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
          Napotkaliśmy nieoczekiwany błąd serwera. Mój system powiadomień został już o tym poinformowany.
        </p>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link href="/" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 glass-panel-interactive px-8 py-3.5 rounded-full text-sm font-medium text-slate-300 transition-all hover:scale-105 active:scale-95">
            Wróć na Główną
          </Link>
        </div>
      </div>
