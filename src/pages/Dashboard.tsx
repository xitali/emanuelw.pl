...
const Dashboard: React.FC = () => {
  ...
  const { messages, loading: messagesLoading, fetchMessages } = useContactStore();
  const { stats: visitStats, loading: visitsLoading, fetchStats } = useVisitStats();
