...
export default function ContactSection({ settings }: ContactSectionProps) {
  ...
  return (
    <section id="kontakt" className="py-24 relative z-10 border-t border-slate-800/60 bg-[#040710]/90">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-6xl mx-auto items-start">
          ...
          <FadeIn direction="right" delay={0.2} className="lg:col-span-5 space-y-6">
            <div className="glass-panel rounded-3xl p-8 border border-slate-800 space-y-6">
              ...
              <div className="space-y-4">
                <a
                  href={`mailto:${email}`}
                  className="flex items-center gap-4 p-4 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-cyan-500/40 text-slate-300 hover:text-cyan-300 transition-colors group"
                >
                  <div className="w-12 h-12 rounded-xl bg-cyan-500/20 border border-cyan-500/30 flex items-center justify-center text-cyan-400 group-hover:scale-105 transition-transform">
                    <Mail className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-[10px] font-mono text-slate-400 uppercase">Adres Email</div>
                ...
                >
                  ...
                  <div>
                    <div className="text-[10px] font-mono text-slate-400 uppercase">Telefon Direct</div>
                    <div className="text-sm font-semibold">{phone}</div>
                  </div>
                </a>

                <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-900/60 border border-slate-800 text-slate-300">
                  <div className="w-12 h-12 rounded-xl bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-emerald-400">
                    <MapPin className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-[10px] font-mono text-slate-400 uppercase">Lokalizacja</div>
              ...
              <div className="pt-4 border-t border-slate-800 space-y-3">
                <div className="text-xs font-mono text-slate-400 uppercase">Profile Społecznościowe:</div>
                <div className="flex gap-3">
                  {github && (
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-slate-900 border border-slate-800 hover:border-cyan-400 flex items-center justify-center text-slate-300 hover:text-cyan-400 transition-colors"
                      aria-label="GitHub"
                    >
                  ...
                  {instagram && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-xl bg-slate-900 border border-slate-800 hover:border-pink-500 flex items-center justify-center text-slate-300 hover:text-pink-400 transition-colors"
                  ...
                  {facebook && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-xl bg-slate-900 border border-slate-800 hover:border-blue-500 flex items-center justify-center text-slate-300 hover:text-blue-400 transition-colors"
                      aria-label="Facebook"
                    >
                      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
          ...
          <FadeIn direction="left" delay={0.4} className="lg:col-span-7">
            <form onSubmit={handleSubmit} className="glass-panel rounded-3xl p-8 border border-cyan-500/30 space-y-6">
              ...
              {autoFilledBadge && (
                <div className="p-3 rounded-2xl bg-cyan-950/80 border border-cyan-500/50 text-cyan-300 text-xs font-mono flex items-center gap-2 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-mono text-slate-300">Twoje Imię *</label>
                  <input
                    type="text"
                    name="name"
                    required
                    placeholder="np. Jan Kowalski"
                    className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-slate-800 focus:border-cyan-400 focus:outline-none text-slate-100 text-sm"
                  />
                </div>

                <div className="space-y-1.5">
                  <label className="text-xs font-mono text-slate-300">Adres Email *</label>
                  <input
                    type="email"
                    name="email"
                    required
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-mono text-slate-300">Temat Wiadomości</label>
                <input
                  type="text"
                  name="subject"
                  value={subject}
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-mono text-slate-300">Wiadomość *</label>
                <textarea
                  name="message"
                  required
                  rows={6}
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-slate-950 border border-slate-800 focus:border-cyan-400 focus:outline-none text-slate-100 text-sm resize-none"
                />
              </div>
